...
import myClip from '../Clips/QCM_Photography_Sampler.mp4'
...
const LandingPage = ({}) => {
    ...
    return (
        ...
        <div className="bg-pink-200 flex relative z-20 items-center">
            <div className="container mx-auto px-6 flex flex-col justify-between items-center relative py-8">
                <div className="flex flex-col">
                    <h1 className="font-normal w-full uppercase text-center text-4xl sm:text-5xl dark:text-white text-gray-800">
                        Qrious Creative Media,Photography
                    </h1>
                    ...
                    <div  className="flex items-center justify-center mt-4">
                        ...
                        <a href="#" hidden={hidden} onClick={()=>{history.push('/design')}}
